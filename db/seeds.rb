...
studio2 = Studio.create!(name:"Air Studios", address: "8400 Santa Monica Blvd, West Hollywood, CA 90069, United States", owner: user2)
...
studio3 = Studio.create!(name:"Allaire Studios", address: "747 N La Cienega Blvd, Los Angeles, CA 90069, United States", owner: user3)
...
studio4 = Studio.create!(name:"Metropolis Studios", address: "8701 Beverly Blvd, West Hollywood, CA 90048, United States", owner: user4)
...
studio5 = Studio.create!(name:"BlackBird Studios", address: "321 N Robertson Blvd, West Hollywood, CA 90048, United States", owner: user5)
...
studio6 = Studio.create!(name:"Capitol Studios", address: "9040 Beverly Blvd, West Hollywood, CA 90048, United States", owner: user6)
